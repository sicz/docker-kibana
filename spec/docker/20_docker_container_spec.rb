...
describe "Docker container", :test => :docker_container do
  ...
  #   [
  #     # [url, stdout, stderr]
  #     [ "http://#{ENV["SERVER_CRT_NAME"]}",
  #       "^#{IO.binread("spec/fixtures/www/index.html")}$",
  #       "\\r\\n< HTTP/1.1 301 Moved Permanently\\r\\n< Location: https://#{ENV["SERVER_CRT_NAME"]}/\\r\\n",
  #     ],
  #     [ "http://#{ENV["SERVER_CRT_NAME"]}/index.html",
  #       "^#{IO.binread("spec/fixtures/www/index.html")}$",
  #       "\\r\\n< HTTP/1.1 301 Moved Permanently\\r\\n< Location: https://#{ENV["SERVER_CRT_NAME"]}/index.html\\r\\n",
  #     ],
  #     [ "https://#{ENV["SERVER_CRT_NAME"]}",
  #       "^#{IO.binread("spec/fixtures/www/index.html")}$",
  #     ],
  #     [ "https://#{ENV["SERVER_CRT_NAME"]}/index.html",
  #       "^#{IO.binread("spec/fixtures/www/index.html")}$",
  #     ],
